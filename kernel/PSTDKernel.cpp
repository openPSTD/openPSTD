...
void PSTDKernel::run(KernelCallback *callback) {
    ...
    switch (solver_num) {
        case 0:
            solver = new SingleThreadSolver(this->scene, callback);
            break;
        case 1:
            solver = new GPUSingleThreadSolver(this->scene, callback);
            break;
        case 2:
            solver = new MultiThreadSolver(this->scene, callback);
            break;
        case 3:
            solver = new GPUMultiThreadSolver(this->scene, callback);
            break;
        default:
            //Raise Error
            break;
