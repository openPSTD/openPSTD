__kernel void derifact_multiplication(__global double *matr, __global double *mati, __global double *vecr, __global double *veci, __global int *fftlen, __global int *fftnum)
{
