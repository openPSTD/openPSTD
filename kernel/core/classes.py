...
class Domain(object):
    ...
    def calc_gpu(self, bt, ct, context, stream, plan_set, g_bufr, g_bufi, mulfunc, dest = None):
        ...
        for domain1, domain2 in itertools.product(domains1, domains2):
            ...
            matrix = spatderp3_gpu(matrix0_indexed,kc,self.cfg.Wlength,self.cfg.A,primary_dimension,secundary_dimension,nearest_2power(Ntot),rmat,matrix1_indexed,matrix2_indexed,a,b,context,stream,plan_set,g_bufr,g_bufi,mulfunc)
