    ...
    namespace Kernel {
        ...
        public:
            ...
            struct Discretization {
                ...
                Eigen::ArrayXcf pressure_deriv_factors_nonstag;
                Eigen::ArrayXcf velocity_deriv_factors_nonstag;
                Eigen::ArrayXcf velocity_deriv_factors_strange;
                Eigen::ArrayXcf velocity_stag_factor_dy;
                Eigen::ArrayXcf velocity_stag_factor_dx;
