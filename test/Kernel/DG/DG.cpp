...
BOOST_AUTO_TEST_SUITE(DG)
    BOOST_AUTO_TEST_SUITE(DG_Advec)
        ...
        BOOST_AUTO_TEST_CASE(DG_Advec_x_start)
        {
            int K = 10;
            int N = 8;
        ...
        BOOST_AUTO_TEST_CASE(DG_Advec_vertices_start)
        {
            int K = 10;
            int N = 8;
        ...
        BOOST_AUTO_TEST_CASE(DG_Advec_Normals_start)
        {
            int K = 10;
            int N = 8;
            MatrixX<double> xExpected(2,10);
        ...
        BOOST_AUTO_TEST_CASE(DG_Advec_rx_start)
        {
            int K = 10;
            int N = 8;
        ...
        BOOST_AUTO_TEST_CASE(DG_Advec_fscale_start)
        {
            int K = 10;
            int N = 8;
