...
void Simulator2::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (Simulator2::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Simulator2::updateText)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Simulator2::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Simulator2::centerScene)) {
                *result = 1;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject Simulator2::staticMetaObject = {
